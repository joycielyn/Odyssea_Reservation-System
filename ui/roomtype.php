...
if(empty($category)){
  ...
  $_SESSION['status'] = "Room Type Field is Empty";
  $_SESSION['status_code'] = "warning";

}else {
  $select = $pdo->prepare("SELECT category FROM tbl_category WHERE category = '$category'");

  $select->execute();

  if ($select->rowCount() > 0) {
      $_SESSION['status'] = "Item already exists. Please create ne one";
      $_SESSION['status_code'] = "warning";
    ...
    <div class="content">
      ...
      <div class="card card-warning card-outline">
              <div class="card-header">
                <h5 class="m-0">Room Type Form</h5>
              </div>
              <div class="card-body">
...
<div class="form-group">
  ...
  <input type="text" class="form-control"  placeholder="Enter Room Type"  value="'.$row->category.'"name="txtcategory" >
</div>
...
<div class="form-group">
  ...
  <input type="text" class="form-control"  placeholder="Enter Room Type" name="txtcategory" >
</div>
